	...
	data := []ParseCase{
		...
		},
		{
			...
			Matcher: createInfix(TokOr,
				...
				createInfix(TokOr,
					createInfix(TokAnd,
						createExpr(TokGreater, "int", 0),
						createExpr(TokLesser, "int", 9),
					),
		...
		},
		{
			...
			Matcher: createExpr(TokEqual, "int", []interface{}{30, 10, 20}),
		},
		{
			Input: "foo[dt == (2020-10-12 13:14:15Z, 2020-10-12T07:08:09.333+00:00)]",
			Depth: TokLevelAny,
			Choices: []Accepter{
				createName("foo", 0),
			},
